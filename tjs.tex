...
\resjob{Software Engineer}{February~2018}{present}
\vspace{-14pt}
\begin{itemize}
\item Lead of Developer Experience team, working on improving developer productivity
...
\vspace{-14pt}
\begin{itemize}
\item Lead/Member of Talent Solutions team working on Recruiter and Jobs products
...
\item Developed for FreeBSD and Linux (Red Hat, Debian, Ubuntu), and in
  AWS and on-premise deployments
\end{itemize}
